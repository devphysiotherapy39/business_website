    ...
    <div className="min-h-screen">
      ...
      <section className="section-padding bg-white min-h-screen">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            ...
            <div className="columns-2 md:columns-3 gap-6">
              ...
              <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
               ...
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_7.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_8.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_9.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_10.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_image3.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_12.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_13.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_14.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_15.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
               <div className="rounded-lg overflow-hidden shadow mb-6 break-inside-avoid">
                <img src="/assets/educational_blogs/education_blog_17.jpeg" alt="Educational Resource 6" className="block w-full" />
              </div>
          ...
          {/* Medical, Rehabilitation & Ayurvedic Products Section */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-primary mb-6 text-center animate-fade-in-up">
              Medical, Rehabilitation & Ayurvedic Products
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 mx-auto">
              {/* Surgical Image 2 */}
              <div className="aspect-w-16 aspect-h-9 bg-gray-100 rounded-lg overflow-hidden shadow">
              ...
              {/* Poster 3 */}
              <div className="aspect-w-16 aspect-h-9 bg-gray-100 rounded-lg overflow-hidden shadow">
                <img src="/assets/surgical/Poster3.jpeg" alt="Poster 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
